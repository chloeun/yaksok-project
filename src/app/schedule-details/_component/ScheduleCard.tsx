...
const ScheduleCard = ({ title, date, time, location, participants }: ScheduleCardProps) => {
  return (
    <div className="w-full min-w-[320px] max-w-md font-gangwonEdu bg-white p-5 py-5 mb-6 tracking-[0.20em] rounded-2xl shadow-md md:max-w-2xl lg:max-w-3xl md:p-6 lg:px-8 lg:py-8 relative z-10">
